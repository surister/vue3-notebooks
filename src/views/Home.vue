...
import ConsoleEditor from "@/components/ConsoleEditor.vue";
import ConsoleTableResults from "@/components/ConsoleTableResults.vue";
        ...
        <template v-else>
          <v-row>
            ...
            <v-col class="pa-5" cols="2">
              <v-select hide-details density="compact" variant="outlined" :items="['sql', 'python']"
                        v-model="cell.language"></v-select>
            </v-col>
            <v-spacer></v-spacer>
